    ...
    <div style={{ padding: '2rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', marginTop: '2rem' }}>
        <div style={{ backgroundColor: '#f0f0f0', padding: '1.5rem', borderRadius: '8px' }}>
          ...
          <button style={{ marginTop: '1rem', padding: '0.5rem 1rem', backgroundColor: '#3498db', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>
            Post Job
          </button>
        </div>
        <div style={{ backgroundColor: '#f0f0f0', padding: '1.5rem', borderRadius: '8px' }}>
          ...
          <button style={{ marginTop: '1rem', padding: '0.5rem 1rem', backgroundColor: '#27ae60', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>
            View Jobs
          </button>
        </div>
        <div style={{ backgroundColor: '#f0f0f0', padding: '1.5rem', borderRadius: '8px' }}>
          ...
          <button style={{ marginTop: '1rem', padding: '0.5rem 1rem', backgroundColor: '#e74c3c', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>
            View Applications
          </button>
        </div>
      </div>
